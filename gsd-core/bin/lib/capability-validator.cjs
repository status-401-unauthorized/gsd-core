...
const VALID_HOOKS_SURFACES = new Set(['settings-json', 'codex-hooks-json', 'cursor-hooks-json', 'copilot-inline', 'cline-rules', 'kimi-hooks-toml', 'grok-hooks-json', 'windsurf-hooks-json', 'none']);
...
const INSTALL_SURFACE_TO_ALLOWED_HOOKS_SURFACES = new Map([
  ...
  ['profile-marker-only',  new Set(['none', 'kimi-hooks-toml', 'grok-hooks-json', 'windsurf-hooks-json'])],
