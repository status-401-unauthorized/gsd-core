...
Um hook pós-ferramenta (`PostToolUse` para o Claude Code, `AfterTool` para o Antigravity CLI) que avisa o agente quando o uso da janela de contexto está elevado.
