...
describe('ADR-857 phase 5e: VALID_CONVERTER_NAMES closed enum', () => {
  ...
  // are genuinely new agent converters (not renamed/leftover), so the upstream
  // agent count grows from 11 to 14. This fork also keeps convertClaudeCommandToGrokSkill
  // and convertClaudeAgentToGrokAgent (17 command/skill/workflow + 15 agent).
