...
function resolveLiveConfigRoots(deps = {}) {
  ...
  // grok is a first-class registry runtime on this fork (~/.grok / GROK_HOME).
  // The extra hardcoded ~/.agents root and extra 'grok' loop id from upstream
  // #3024 (legacy non-registry branch) would watch the wrong home.
  //
